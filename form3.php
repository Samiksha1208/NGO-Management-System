  ...
  <ul class="nav nav-tabs" id=tab>
   ...
   <label for="inputEmail4" class="form-label">Email</label>
    ...
    <div class="col-md-6">
      ...
      <input type="tel" class="form-control" id="card" name="Card_no">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      ...
      <input type="month" class="form-control" id="inputCity" name="Exp">
    </div>
    <div class="col-md-6">
      <label for="money" class="form-label">Amount (INR)</label>
      <input type="number" class="form-control" id="money" name="Amount">
    </div>
    <div class="col-12">
