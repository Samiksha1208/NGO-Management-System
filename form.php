...
<div class="container6">
  ...
  <form name="form1" class="row g-3" onsubmit="return validateForm()"  action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
  <div class="col-md-6">
 ...
 <label for="inputEmail4" class="form-label">Email</label>
  ...
  <div class="col-4">
      ...
      <input type="text" class="form-control" id="Area_found" name="Area_found">
    </div>
  <div class="col-4">
